...
func NewList(x int, y int, cx int, cy int, hParent int) *List {
	p := &List{}
	p.W置句柄(xc.XList_Create(x, y, cx, cy, hParent))
	return p
}
...
func (l *List) AddColumn(width int) int {
	return xc.XList_AddColumn(l.W句柄, width)
}
...
func (l *List) InsertColumn(width int, iItem int) int {
	return xc.XList_InsertColumn(l.W句柄, width, iItem)
}
...
func (l *List) EnableMultiSel(bEnable bool) int {
	return xc.XList_EnableMultiSel(l.W句柄, bEnable)
}
...
func (l *List) EnableDragChangeColumnWidth(bEnable bool) int {
	return xc.XList_EnableDragChangeColumnWidth(l.W句柄, bEnable)
}
...
func (l *List) EnableVScrollBarTop(bTop bool) int {
	return xc.XList_EnableVScrollBarTop(l.W句柄, bTop)
}
...
func (l *List) EnableItemBkFullRow(bFull bool) int {
	return xc.XList_EnableItemBkFullRow(l.W句柄, bFull)
}
...
func (l *List) EnableFixedRowHeight(bEnable bool) int {
	return xc.XList_EnableFixedRowHeight(l.W句柄, bEnable)
}
...
func (l *List) EnableTemplateReuse(bEnable bool) int {
	return xc.XList_EnableTemplateReuse(l.W句柄, bEnable)
}
...
func (l *List) EnableVirtualTable(bEnable bool) int {
	return xc.XList_EnableVirtualTable(l.W句柄, bEnable)
}
...
func (l *List) SetVirtualRowCount(nRowCount int) int {
	return xc.XList_SetVirtualRowCount(l.W句柄, nRowCount)
}
...
func (l *List) SetSort(iColumn int, iColumnAdapter int, bEnable bool) int {
	return xc.XList_SetSort(l.W句柄, iColumn, iColumnAdapter, bEnable)
}
...
func (l *List) SetDrawItemBkFlags(nFlags xcc.List_DrawItemBk_Flag_) int {
	return xc.XList_SetDrawItemBkFlags(l.W句柄, nFlags)
}
...
func (l *List) SetColumnWidth(iItem int, width int) int {
	return xc.XList_SetColumnWidth(l.W句柄, iItem, width)
}
...
func (l *List) SetColumnMinWidth(iItem int, width int) int {
	return xc.XList_SetColumnMinWidth(l.W句柄, iItem, width)
}
...
func (l *List) SetColumnWidthFixed(iColumn int, bFixed bool) int {
	return xc.XList_SetColumnWidthFixed(l.W句柄, iColumn, bFixed)
}
...
func (l *List) GetColumnWidth(iColumn int) int {
	return xc.XList_GetColumnWidth(l.W句柄, iColumn)
}

// 列表_取列数量.
func (l *List) GetColumnCount() int {
	return xc.XList_GetColumnCount(l.W句柄)
}
...
func (l *List) SetItemData(iItem int, iSubItem int, data int) bool {
	return xc.XList_SetItemData(l.W句柄, iItem, iSubItem, data)
}
...
func (l *List) GetItemData(iItem int, iSubItem int) int {
	return xc.XList_GetItemData(l.W句柄, iItem, iSubItem)
}
...
func (l *List) SetSelectItem(iItem int) bool {
	return xc.XList_SetSelectItem(l.W句柄, iItem)
}

// 列表_取选择项, 返回项索引.
func (l *List) GetSelectItem() int {
	return xc.XList_GetSelectItem(l.W句柄)
}

// 列表_取选择项数量, 获取选择项数量.
func (l *List) GetSelectItemCount() int {
	return xc.XList_GetSelectItemCount(l.W句柄)
}
...
func (l *List) AddSelectItem(iItem int) bool {
	return xc.XList_AddSelectItem(l.W句柄, iItem)
}

// 列表_置选择全部, 选择全部行.
func (l *List) SetSelectAll() int {
	return xc.XList_SetSelectAll(l.W句柄)
}
...
func (l *List) GetSelectAll(pArray *[]int32, nArraySize int) int {
	return xc.XList_GetSelectAll(l.W句柄, pArray, nArraySize)
}
...
func (l *List) VisibleItem(iItem int) int {
	return xc.XList_VisibleItem(l.W句柄, iItem)
}
...
func (l *List) CancelSelectItem(iItem int) bool {
	return xc.XList_CancelSelectItem(l.W句柄, iItem)
}

// 列表_取消全部选择项, 取消选择所有项(这里的项可以理解为行).
func (l *List) CancelSelectAll() int {
	return xc.XList_CancelSelectAll(l.W句柄)
}

// 列表_取列表头, 获取列表头元素, 返回列表头元素句柄.
func (l *List) GetHeaderHELE() int {
	return xc.XList_GetHeaderHELE(l.W句柄)
}
...
func (l *List) DeleteColumn(iItem int) bool {
	return xc.XList_DeleteColumn(l.W句柄, iItem)
}

// 列表_删除全部列, 删除所有的列, 仅删除List的, 数据适配器的列不变.
func (l *List) DeleteColumnAll() int {
	return xc.XList_DeleteColumnAll(l.W句柄)
}
...
func (l *List) BindAdapter(hAdapter int) int {
	return xc.XList_BindAdapter(l.W句柄, hAdapter)
}
...
func (l *List) BindAdapterHeader(hAdapter int) int {
	return xc.XList_BindAdapterHeader(l.W句柄, hAdapter)
}
...
func (l *List) SetItemTemplateXML(pXmlFile string) bool {
	return xc.XList_SetItemTemplateXML(l.W句柄, pXmlFile)
}
...
func (l *List) SetItemTemplateXMLFromString(pStringXML string) bool {
	return xc.XList_SetItemTemplateXMLFromString(l.W句柄, pStringXML)
}
...
func (l *List) SetItemTemplate(hTemp int) bool {
	return xc.XList_SetItemTemplate(l.W句柄, hTemp)
}
...
func (l *List) GetTemplateObject(iItem int, iSubItem int, nTempItemID int) int {
	return xc.XList_GetTemplateObject(l.W句柄, iItem, iSubItem, nTempItemID)
}
...
func (l *List) GetItemIndexFromHXCGUI(hXCGUI int) int {
	return xc.XList_GetItemIndexFromHXCGUI(l.W句柄, hXCGUI)
}
...
func (l *List) GetHeaderTemplateObject(iItem int, nTempItemID int) int {
	return xc.XList_GetHeaderTemplateObject(l.W句柄, iItem, nTempItemID)
}
...
func (l *List) GetHeaderItemIndexFromHXCGUI(hXCGUI int) int {
	return xc.XList_GetHeaderItemIndexFromHXCGUI(l.W句柄, hXCGUI)
}
...
func (l *List) SetHeaderHeight(height int) int {
	return xc.XList_SetHeaderHeight(l.W句柄, height)
}

// 列表_取列表头高度.
func (l *List) GetHeaderHeight() int {
	return xc.XList_GetHeaderHeight(l.W句柄)
}
...
func (l *List) GetVisibleRowRange(piStart *int, piEnd *int) int {
	return xc.XList_GetVisibleRowRange(l.W句柄, piStart, piEnd)
}
...
func (l *List) SetItemHeightDefault(nHeight int, nSelHeight int) int {
	return xc.XList_SetItemHeightDefault(l.W句柄, nHeight, nSelHeight)
}
...
func (l *List) GetItemHeightDefault(pHeight *int, pSelHeight *int) int {
	return xc.XList_GetItemHeightDefault(l.W句柄, pHeight, pSelHeight)
}
...
func (l *List) SetRowSpace(nSpace int) int {
	return xc.XList_SetRowSpace(l.W句柄, nSpace)
}

// 列表_取行间距.
func (l *List) GetRowSpace() int {
	return xc.XList_GetRowSpace(l.W句柄)
}
...
func (l *List) SetLockColumnLeft(iColumn int) int {
	return xc.XList_SetLockColumnLeft(l.W句柄, iColumn)
}
...
func (l *List) SetLockColumnRight(iColumn int) int {
	return xc.XList_SetLockColumnRight(l.W句柄, iColumn)
}
...
func (l *List) SetLockRowBottom(bLock bool) int {
	return xc.XList_SetLockRowBottom(l.W句柄, bLock)
}
...
func (l *List) SetLockRowBottomOverlap(bOverlap bool) int {
	return xc.XList_SetLockRowBottomOverlap(l.W句柄, bOverlap)
}
...
func (l *List) HitTest(pPt *xc.POINT, piItem *int, piSubItem *int) bool {
	return xc.XList_HitTest(l.W句柄, pPt, piItem, piSubItem)
}
...
func (l *List) HitTestOffset(pPt *xc.POINT, piItem *int, piSubItem *int) bool {
	return xc.XList_HitTestOffset(l.W句柄, pPt, piItem, piSubItem)
}

// 列表_刷新项数据.
func (l *List) RefreshData() int {
	return xc.XList_RefreshData(l.W句柄)
}
...
func (l *List) RefreshItem(iItem int) int {
	return xc.XList_RefreshItem(l.W句柄, iItem)
}
...
func (l *List) AddColumnText(nWidth int, pName string, pText string) int {
	return xc.XList_AddColumnText(l.W句柄, nWidth, pName, pText)
}
...
func (l *List) AddColumnImage(nWidth int, pName string, hImage int) int {
	return xc.XList_AddColumnImage(l.W句柄, nWidth, pName, hImage)
}
...
func (l *List) AddItemText(pText string) int {
	return xc.XList_AddItemText(l.W句柄, pText)
}
...
func (l *List) AddItemTextEx(pName string, pText string) int {
	return xc.XList_AddItemTextEx(l.W句柄, pName, pText)
}
...
func (l *List) AddItemImage(hImage int) int {
	return xc.XList_AddItemImage(l.W句柄, hImage)
}
...
func (l *List) AddItemImageEx(pName string, hImage int) int {
	return xc.XList_AddItemImageEx(l.W句柄, pName, hImage)
}
...
func (l *List) InsertItemText(iItem int, pValue string) int {
	return xc.XList_InsertItemText(l.W句柄, iItem, pValue)
}
...
func (l *List) InsertItemTextEx(iItem int, pName string, pValue string) int {
	return xc.XList_InsertItemTextEx(l.W句柄, iItem, pName, pValue)
}
...
func (l *List) InsertItemImage(iItem int, hImage int) int {
	return xc.XList_InsertItemImage(l.W句柄, iItem, hImage)
}
...
func (l *List) InsertItemImageEx(iItem int, pName string, hImage int) int {
	return xc.XList_InsertItemImageEx(l.W句柄, iItem, pName, hImage)
}
...
func (l *List) SetItemText(iItem int, iColumn int, pText string) bool {
	return xc.XList_SetItemText(l.W句柄, iItem, iColumn, pText)
}
...
func (l *List) SetItemTextEx(iItem int, pName string, pText string) bool {
	return xc.XList_SetItemTextEx(l.W句柄, iItem, pName, pText)
}
...
func (l *List) SetItemImage(iItem int, iColumn int, hImage int) bool {
	return xc.XList_SetItemImage(l.W句柄, iItem, iColumn, hImage)
}
...
func (l *List) SetItemImageEx(iItem int, pName string, hImage int) bool {
	return xc.XList_SetItemImageEx(l.W句柄, iItem, pName, hImage)
}
...
func (l *List) SetItemInt(iItem int, iColumn int, nValue int) bool {
	return xc.XList_SetItemInt(l.W句柄, iItem, iColumn, nValue)
}
...
func (l *List) SetItemIntEx(iItem int, pName string, nValue int) bool {
	return xc.XList_SetItemIntEx(l.W句柄, iItem, pName, nValue)
}
...
func (l *List) SetItemFloat(iItem int, iColumn int, fFloat float32) bool {
	return xc.XList_SetItemFloat(l.W句柄, iItem, iColumn, fFloat)
}
...
func (l *List) SetItemFloatEx(iItem int, pName string, fFloat float32) bool {
	return xc.XList_SetItemFloatEx(l.W句柄, iItem, pName, fFloat)
}
...
func (l *List) GetItemText(iItem int, iColumn int) string {
	return xc.XList_GetItemText(l.W句柄, iItem, iColumn)
}
...
func (l *List) GetItemTextEx(iItem int, pName string) string {
	return xc.XList_GetItemTextEx(l.W句柄, iItem, pName)
}
...
func (l *List) GetItemImage(iItem int, iColumn int) int {
	return xc.XList_GetItemImage(l.W句柄, iItem, iColumn)
}
...
func (l *List) GetItemImageEx(iItem int, pName string) int {
	return xc.XList_GetItemImageEx(l.W句柄, iItem, pName)
}
...
func (l *List) GetItemInt(iItem int, iColumn int, pOutValue *int) bool {
	return xc.XList_GetItemInt(l.W句柄, iItem, iColumn, pOutValue)
}
...
func (l *List) GetItemIntEx(iItem int, pName string, pOutValue *int) bool {
	return xc.XList_GetItemIntEx(l.W句柄, iItem, pName, pOutValue)
}
...
func (l *List) GetItemFloat(iItem int, iColumn int, pOutValue *float32) bool {
	return xc.XList_GetItemFloat(l.W句柄, iItem, iColumn, pOutValue)
}
...
func (l *List) GetItemFloatEx(iItem int, pName string, pOutValue *float32) bool {
	return xc.XList_GetItemFloatEx(l.W句柄, iItem, pName, pOutValue)
}
...
func (l *List) DeleteItem(iItem int) bool {
	return xc.XList_DeleteItem(l.W句柄, iItem)
}
...
func (l *List) DeleteItemEx(iItem int, nCount int) bool {
	return xc.XList_DeleteItemEx(l.W句柄, iItem, nCount)
}

// 列表_删除项全部.
func (l *List) DeleteItemAll() int {
	return xc.XList_DeleteItemAll(l.W句柄)
}

// 列表_删除列全部AD.
func (l *List) DeleteColumnAll_AD() int {
	return xc.XList_DeleteColumnAll_AD(l.W句柄)
}

// 列表_取项数量AD.
func (l *List) GetCount_AD() int {
	return xc.XList_GetCount_AD(l.W句柄)
}

// 列表_取列数量AD.
func (l *List) GetCountColumn_AD() int {
	return xc.XList_GetCountColumn_AD(l.W句柄)
}
...
func (l *List) SetSplitLineColor(color int) int {
	return xc.XList_SetSplitLineColor(l.W句柄, color)
}
...
func (l *List) SetItemHeight(iRow int, nHeight int, nSelHeight int) int {
	return xc.XList_SetItemHeight(l.W句柄, iRow, nHeight, nSelHeight)
}
...
func (l *List) GetItemHeight(iRow int, pHeight *int, pSelHeight *int) int {
	return xc.XList_GetItemHeight(l.W句柄, iRow, pHeight, pSelHeight)
}
...
func (l *List) SetDragRectColor(color, width int) int {
	return xc.XList_SetDragRectColor(l.W句柄, color, width)
}

// 列表_取项模板. 返回列表项模板句柄.
func (l *List) GetItemTemplate() int {
	return xc.XList_GetItemTemplate(l.W句柄)
}

// 列表_取项模板列表头. 返回列表头项模板句柄.
func (l *List) GetItemTemplateHeader() int {
	return xc.XList_GetItemTemplateHeader(l.W句柄)
}

// 列表_刷新项数据列表头.
func (l *List) RefreshDataHeader() int {
	return xc.XList_RefreshDataHeader(l.W句柄)
}
...
func (l *List) Event_LIST_TEMP_CREATE(pFun XE_LIST_TEMP_CREATE) bool {
	return xc.XEle_RegEventC(l.W句柄, xcc.XE_LIST_TEMP_CREATE, pFun)
}

// 列表元素-项模板创建事件,模板复用机制需先启用;替换模板无效判断nFlag,因为内部会检查模板是否改变,不用担心重复.
func (l *List) Event_LIST_TEMP_CREATE1(pFun XE_LIST_TEMP_CREATE1) bool {
	return xc.XEle_RegEventC1(l.W句柄, xcc.XE_LIST_TEMP_CREATE, pFun)
}
