...
func NewTabBar(x int, y int, cx int, cy int, hParent int) *TabBar {
	p := &TabBar{}
	p.W置句柄(xc.XTabBar_Create(x, y, cx, cy, hParent))
	return p
}
...
func (t *TabBar) AddLabel(pName string) int {
	return xc.XTabBar_AddLabel(t.W句柄, pName)
}
...
func (t *TabBar) InsertLabel(index int, pName string) int {
	return xc.XTabBar_InsertLabel(t.W句柄, index, pName)
}
...
func (t *TabBar) MoveLabel(iSrc int, iDest int) bool {
	return xc.XTabBar_MoveLabel(t.W句柄, iSrc, iDest)
}
...
func (t *TabBar) DeleteLabel(index int) bool {
	return xc.XTabBar_DeleteLabel(t.W句柄, index)
}

// TAB条_删除全部, 删除所有标签.
func (t *TabBar) DeleteLabelAll() int {
	return xc.XTabBar_DeleteLabelAll(t.W句柄)
}
...
func (t *TabBar) GetLabel(index int) int {
	return xc.XTabBar_GetLabel(t.W句柄, index)
}
...
func (t *TabBar) GetindexByEle(hLabel int) int {
	return xc.XTabBar_GetindexByEle(t.W句柄, hLabel)
}
...
func (t *TabBar) SetLabelSpacing(spacing int) int {
	return xc.XTabBar_SetLabelSpacing(t.W句柄, spacing)
}
...
func (t *TabBar) SetPadding(left int, top int, right int, bottom int) int {
	return xc.XTabBar_SetPadding(t.W句柄, left, top, right, bottom)
}
...
func (t *TabBar) SetSelect(index int) int {
	return xc.XTabBar_SetSelect(t.W句柄, index)
}

// TAB条_左滚动, 左按钮滚动.
func (t *TabBar) SetUp() int {
	return xc.XTabBar_SetUp(t.W句柄)
}

// TAB条_右滚动, 右按钮滚动.
func (t *TabBar) SetDown() int {
	return xc.XTabBar_SetDown(t.W句柄)
}
...
func (t *TabBar) EnableTile(bTile bool) int {
	return xc.XTabBar_EnableTile(t.W句柄, bTile)
}
...
func (t *TabBar) EnableDropMenu(bEnable bool) int {
	return xc.XTabBar_EnableDropMenu(t.W句柄, bEnable)
}
...
func (t *TabBar) EnableClose(bEnable bool) int {
	return xc.XTabBar_EnableClose(t.W句柄, bEnable)
}
...
func (t *TabBar) SetCloseSize(pSize *xc.SIZE) int {
	return xc.XTabBar_SetCloseSize(t.W句柄, pSize)
}
...
func (t *TabBar) SetTurnButtonSize(pSize *xc.SIZE) int {
	return xc.XTabBar_SetTurnButtonSize(t.W句柄, pSize)
}
...
func (t *TabBar) SetLabelWidth(index int, nWidth int) int {
	return xc.XTabBar_SetLabelWidth(t.W句柄, index, nWidth)
}
...
func (t *TabBar) ShowLabel(index int, bShow bool) bool {
	return xc.XTabBar_ShowLabel(t.W句柄, index, bShow)
}
...
func (t *TabBar) Event_TABBAR_SELECT(pFun XE_TABBAR_SELECT) bool {
	return xc.XEle_RegEventC(t.W句柄, xcc.XE_TABBAR_SELECT, pFun)
}

// TabBar标签按钮选择改变事件.
func (t *TabBar) Event_TABBAR_SELECT1(pFun XE_TABBAR_SELECT1) bool {
	return xc.XEle_RegEventC1(t.W句柄, xcc.XE_TABBAR_SELECT, pFun)
}

// TabBar标签按钮删除事件.
func (t *TabBar) Event_TABBAR_DELETE(pFun XE_TABBAR_DELETE) bool {
	return xc.XEle_RegEventC(t.W句柄, xcc.XE_TABBAR_DELETE, pFun)
}

// TabBar标签按钮删除事件.
func (t *TabBar) Event_TABBAR_DELETE1(pFun XE_TABBAR_DELETE1) bool {
	return xc.XEle_RegEventC1(t.W句柄, xcc.XE_TABBAR_DELETE, pFun)
}
