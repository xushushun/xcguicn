...
func (s *Shape) RemoveShape() int {
	return xc.XShape_RemoveShape(s.W句柄)
}

// 形状_取Z序, 获取形状对象Z序, 成功返回索引值, 否则返回 XC_ID_ERROR.
func (s *Shape) GetZOrder() int {
	return xc.XShape_GetZOrder(s.W句柄)
}

// 形状_重绘, 重绘形状对象.
func (s *Shape) Redraw() int {
	return xc.XShape_Redraw(s.W句柄)
}

// 形状_取宽度, 获取内容宽度.
func (s *Shape) GetWidth() int {
	return xc.XShape_GetWidth(s.W句柄)
}

// 形状_取高度, 获取内容高度.
func (s *Shape) GetHeight() int {
	return xc.XShape_GetHeight(s.W句柄)
}
...
func (s *Shape) SetPosition(x int, y int) int {
	return xc.XShape_SetPosition(s.W句柄, x, y)
}
...
func (s *Shape) GetRect(pRect *xc.RECT) int {
	return xc.XShape_GetRect(s.W句柄, pRect)
}
...
func (s *Shape) SetRect(pRect *xc.RECT) int {
	return xc.XShape_SetRect(s.W句柄, pRect)
}
...
func (s *Shape) SetRectLogic(pRect *xc.RECT, bRedraw bool) bool {
	return xc.XShape_SetRectLogic(s.W句柄, pRect, bRedraw)
}
...
func (s *Shape) GetRectLogic(pRect *xc.RECT) int {
	return xc.XShape_GetRectLogic(s.W句柄, pRect)
}
...
func (s *Shape) GetWndClientRect(pRect *xc.RECT) int {
	return xc.XShape_GetWndClientRect(s.W句柄, pRect)
}
...
func (s *Shape) GetContentSize(pSize *xc.SIZE) int {
	return xc.XShape_GetContentSize(s.W句柄, pSize)
}
...
func (s *Shape) ShowLayout(bShow bool) int {
	return xc.XShape_ShowLayout(s.W句柄, bShow)
}

// 形状_调整布局.
func (s *Shape) AdjustLayout() int {
	return xc.XShape_AdjustLayout(s.W句柄)
}

// 形状_销毁, 销毁形状对象.
func (s *Shape) Destroy() int {
	return xc.XShape_Destroy(s.W句柄)
}
...
func (s *Shape) GetPosition(pOutX *int, pOutY *int) int {
	return xc.XShape_GetPosition(s.W句柄, pOutX, pOutY)
}
...
func (s *Shape) SetSize(nWidth int, nHeight int) int {
	return xc.XShape_SetSize(s.W句柄, nWidth, nHeight)
}
...
func (s *Shape) GetSize(pOutWidth *int, pOutHeight *int) int {
	return xc.XShape_GetSize(s.W句柄, pOutWidth, pOutHeight)
}
...
func (s *Shape) SetAlpha(alpha uint8) int {
	return xc.XShape_SetAlpha(s.W句柄, alpha)
}

// 形状_取透明度, 返回透明度.
func (s *Shape) GetAlpha() int {
	return xc.XShape_GetAlpha(s.W句柄)
}
